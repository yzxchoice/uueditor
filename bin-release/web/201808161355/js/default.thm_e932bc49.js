window.skins={};
	...
	function TabStyleSkin() {
		_super.call(this);
		this.skinParts = ["input_width","input_width0","input_width2","input_width1","input_width3","gp_inputContainer","btn_update","gp_eventContainer_style"];
	...
	_proto.gp_eventContainer_style_i = function () {
		...
		t.x = 0;
		t.y = 0;
		t.elementsContent = [this._Rect1_i(),this.gp_inputContainer_i(),this.btn_update_i()];
		return t;
	};
	_proto._Rect1_i = function () {
		var t = new eui.Rect();
	...
	function SiderbarSkin() {
		_super.call(this);
		this.skinParts = ["gp_tab_page","gp_tab_style","gp_tab_animation","gp_tab_event","gp_tabs","component_style","component_animation","component_event","gp_eventContainers","gp_add_click_event","gp_container_addEvent"];
		...
		this.states = [
			new eui.State ("page",
				[
					new eui.AddItems("_PageBox1","gp_eventContainers",0,""),
			...
			new eui.State ("style",
				[
					new eui.AddItems("component_style","gp_eventContainers",1,""),
			...
			new eui.State ("animation",
				[
					new eui.AddItems("component_animation","gp_eventContainers",1,""),
			...
			new eui.State ("event",
				[
					new eui.AddItems("component_event","gp_eventContainers",1,""),
	...
	_proto.gp_tabs_i = function () {
		...
		t.elementsContent = [this.gp_tab_page_i(),this.gp_tab_style_i(),this.gp_tab_animation_i(),this.gp_tab_event_i()];
		return t;
	};
	...
	_proto.gp_container_addEvent_i = function () {
		...
		t.x = 0;
		t.y = 120;
		t.elementsContent = [this._Rect7_i(),this._Group2_i(),this._Group3_i()];
		return t;
	};
	...
	_proto._Group2_i = function () {
		...
		t.x = 0;
		t.y = 0;
		t.elementsContent = [this._Rect8_i(),this._Label6_i()];
		return t;
	};
	...
	_proto.gp_add_click_event_i = function () {
		...
		t.width = 500;
		t.y = 0;
		t.elementsContent = [this._Label7_i(),this._Rect9_i()];
		return t;
	};
