window.skins={};
	...
	function TabStyleSkin() {
		_super.call(this);
		this.skinParts = ["gp_diff","input_width","input_width0","input_width2","input_width1","input_width3","gp_inputContainer","gp_container","gp_eventContainer_style"];
	...
	_proto.gp_eventContainer_style_i = function () {
		...
		t.elementsContent = [this._Rect1_i(),this.gp_container_i()];
		return t;
	};
	...
	_proto._Group6_i = function () {
		var t = new eui.Group();
		t.layout = this._VerticalLayout1_i();
		t.elementsContent = [this.gp_diff_i(),this.gp_inputContainer_i()];
		return t;
	};
	_proto._VerticalLayout1_i = function () {
		var t = new eui.VerticalLayout();
	...
	return Start;
})(eui.Skin);generateEUI.paths['resource/skins/StyleCircleSectorSkin.exml'] = window.Style = (function (_super) {
	__extends(Style, _super);
	function Style() {
		_super.call(this);
		this.skinParts = ["lb_edit"];
	...
	_proto._Group1_i = function () {
		...
		t.y = 0;
		t.layout = this._HorizontalLayout1_i();
		t.elementsContent = [this._Label1_i(),this.lb_edit_i()];
		return t;
	};
	_proto._HorizontalLayout1_i = function () {
		var t = new eui.HorizontalLayout();
	...
	return Style;
})(eui.Skin);generateEUI.paths['resource/skins/StyleImageSkin.exml'] = window.StyleInputSkin = (function (_super) {
	__extends(StyleInputSkin, _super);
	function StyleInputSkin() {
		_super.call(this);
		this.skinParts = ["btn_image"];
		
		this.width = 500;
		this.elementsContent = [this._Group1_i()];
		
		eui.Binding.$bindProperties(this, ["hostComponent.stateObj.title"],[0],this._Label1,"text");
		eui.Binding.$bindProperties(this, ["hostComponent.stateObj.content"],[0],this.btn_image,"label");
	}
	...
	_proto._Group1_i = function () {
		...
		t.y = 0;
		t.layout = this._HorizontalLayout1_i();
		t.elementsContent = [this._Label1_i(),this.btn_image_i()];
		return t;
	};
	_proto._HorizontalLayout1_i = function () {
		var t = new eui.HorizontalLayout();
...
})(eui.Skin);generateEUI.paths['resource/skins/TableSkin.exml'] = window.TableSkin = (function (_super) {
	__extends(TableSkin, _super);
	function TableSkin() {
		_super.call(this);
		this.skinParts = ["gp_box","gp_btnBox"];
	...
	_proto._Group1_i = function () {
		...
		t.y = 0;
		t.layout = this._VerticalLayout2_i();
		t.elementsContent = [this.gp_box_i(),this.gp_btnBox_i()];
		return t;
	};
	_proto._VerticalLayout2_i = function () {
		var t = new eui.VerticalLayout();
